<div class="special-slide">
    <div class="container">
                    ...
                    <div class="banner-contain">
                        <div class="media">
                            <a href="#" class="bn-link">
                                <figure><img src="assets/images/home-03/smart-phone-half-block.jpg" width="616" height="483" alt=""></figure>
                            </a>
                        </div>
                        <div class="text-content">
                            <b class="first-line">Verious</b>
                            <span class="second-line">Number one brand</span>
                            <span class="third-line">Easy <i>Purchase, Happy Life</i></span>
                            <div class="product-detail">
                                <h4 class="product-name">National brand collection</h4>
        ...
        <div class="biolife-service type01 biolife-service__type01 sm-margin-top-0 xs-margin-top-45px">
            ...
            <i class="txt-show-02" >New Product</i>
