            ...
            <div class="col-lg-6 col-md-7 hidden-sm hidden-xs">
                <div class="primary-menu">
                    <ul class="menu biolife-menu clone-main-menu clone-primary-menu" id="primary-menu" data-menuname="main menu">
                                ...
                                <div class="mega-content">
                                    <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                        <div class="wrap-custom-menu vertical-menu">
                                            <h4 class="menu-title">All Product Category</h4> <!-- Show Category list in nav -->
                                            <ul class="menu">
                                                <?php foreach($ctgDatas as $ctgData) { ?>
                                                <li><a href="categorywise_product.php?status=catview&&id=<?php echo $ctgData['ctg_id']; ?>"><?php echo $ctgData['ctg_name']; ?></a></li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                    </div>                                                                 
                        ...
                        <li class="menu-item menu-item-has-children has-megamenu">
                            <a href="#" class="menu-name" data-title="Shop" >Brand</a> <!-- Show brand list in nav -->
                            <div class="wrap-megamenu lg-width-900 md-width-750">
                                <div class="mega-content">
                                    <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                        <div class="wrap-custom-menu vertical-menu">
                                            <h4 class="menu-title">All Brand Category</h4>
                                            <ul class="menu">
                                                <?php foreach($brandDatas as $brandData) { ?>
                                                <li><a href="brandwise_product.php?status=brandview&&id=<?php echo $brandData['brand_id']; ?>"><?php echo $brandData['brand_name']; ?></a></li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                    </div>                                                                 
