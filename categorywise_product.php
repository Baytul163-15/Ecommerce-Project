...
<?php
    ...
    if (isset($_GET['status'])) {
        ...
        if ($_GET['status']== 'catview') {
            $catData = $obj_clintside->product_by_ctg($catId);
            $pros = array();
            while($prodatas = mysqli_fetch_assoc($catData)){
                $pros[] = $prodatas;
            }     
        }
    } 
    ...
    if (isset($_GET['status'])) {
        $catId = $_GET['id'];
        if ($_GET['status']== 'catview') {
            $catName = $obj_clintside->display_product_category_name($catId);  
        }
    }
?>
                                    ...
                                    <li class="product-item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                        <div class="contain-product layout-default">
                                            <div class="product-thumb">
                                                <a href="single_product.php?status=singlepro&&id=<?php echo $pro['pdt_id']; ?>" class="link-to-product">
                                            ...
                                            <div class="info">
                                                ...
                                                <h4 class="product-title"><a href="single_product.php?status=singlepro&&id=<?php echo $pro['pdt_id']; ?>" class="pr-name"><?php echo $pro['pdt_name']; ?></a></h4>
                                                <div class="price">
                                                ...
                                                <div class="slide-down-box">
                                                    ...
                                                    <div class="buttons">
                                                        ...
                                                        <a href="single_product.php?status=singlepro&&id=<?php echo $pro['pdt_id']; ?>" class="btn compare-btn"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
