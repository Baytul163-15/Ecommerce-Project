...
<?php
    ...
    //status and id using value pass in adminBack function from single_product page.
    if (isset($_GET['status'])) {
        $singleId = $_GET['id'];
        if ($_GET['status']== 'singlepro') {
            $singleData = $obj_clintside->display_single_product($singleId);
            $pros = array();
            $prodatas = mysqli_fetch_assoc($singleData);
            $pros[] = $prodatas;    
        }
    } 

    //single page: related product show.
    $cat_id = $prodatas['ctg_id'];
    $relatedData = $obj_clintside->display_related_product($cat_id);
?>
                                    ...
                                    <div>
                                        ...
                                        <div class="sumary-product single-layout">
                                            ...
                                            <div class="product-attribute">
                                                ...
                                                <div class="rating">
                                                    ...
                                                    <b class="category">Cat By: <?php echo $pro['ctg_name']; ?></b>
                                                </div>
                                                <span class="sku">Brand: <?php echo $pro['brand_name']; ?></span> <br>
                                            ...
                                            <div class="action-form">
                                                <!-- <div class="quantity-box">
                                                    <form action="" method="POST">
                                                        ...
                                                        <br>
                                                        <input type="submit" class="btn btn-success" value="Update Total" name="update_total">
                                                    </form>
                                                </div> -->
                                                <div class="total-price-contain">
                                                    ...
                                                    <p class="price">
                                                        <?php
                                                            ...
                                                            //     }else{
                                                            //         echo "TK.".$pro['pdt_price'] * $quantity;
                                                            //     }
                                                            // }else{
                                                            //     echo $pro['pdt_price'];
                                                            // }
                                                ...
                                                <div class="buttons">
                                                    <input type="hidden" name="pdt_name" value="<?php echo $pro['pdt_name']; ?>"> <!--Pro_name add in addtocart page-->
                                                    <input type="hidden" name="pdt_img" value="<?php echo $pro['pdt_img']; ?>"> <!--Pro_img add in addtocart page-->
                                                    <input type="hidden" name="pdt_price" value="<?php echo $pro['pdt_price']; ?>"> <!--Pro_price add in addtocart page-->
                                                    <input type="submit" name="addtocart" href="#" value="Add To Cart" class="btn btn-block add-to-cart-btn">
                                                    <p class="pull-row">
                                        ...
                                        <div class="product-related-box single-layout">
                                            ...
                                            <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":0,"slidesToShow":5, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":20 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}}]}'>
                                                <?php while ($result = mysqli_fetch_assoc($relatedData)) { ?>
                                                    <li class="product-item">
                                                        <div class="contain-product layout-default">
                                                            <div class="product-thumb">
                                                                <a href="single_product.php?status=singlepro&&id=<?php echo $result['pdt_id']; ?>" class="link-to-product">
                                                                    <img src="admin/Upload/<?php echo $result['pdt_img']; ?>" alt="dd" width="270" height="270" class="product-thumnail">
                                                                </a>
                                                            </div>
                                                            <div class="info">
                                                                <b class="categories"><?php echo $result['ctg_name']; ?></b>
                                                                <h4 class="product-title"><a href="single_product.php?status=singlepro&&id=<?php echo $result['pdt_id']; ?>" class="pr-name"><?php echo $result['pdt_name']; ?></a></h4>
                                                                <div class="price">
                                                                    <ins><span class="price-amount"><span class="currencySymbol">£</span><?php echo $result['pdt_price']; ?></span></ins>
                                                                    <del><span class="price-amount"><span class="currencySymbol">£</span>95.00</span></del>
                                                                </div>
                                                                <div class="slide-down-box">
                                                                    ...
                                                                    <div class="buttons">
                                                                        ...
                                                                        <a href="single_product.php?status=singlepro&&id=<?php echo $result['pdt_id']; ?>" class="btn compare-btn"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
